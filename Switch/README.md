...
- Tact switch: 택트 스위치는 버튼을 누르는 순간에만 회로가 연결되는 '순간 접점형 스위치(Momentary Switch)'로, 누르면 딸깍하는 촉감과 함께 전류가 흐르고, 손을 떼면 자동으로 원래 상태로 복귀하는 작은 전자 부품[[1]](#ref_1)
...
[1]<a id="ref_1"></a> [Tact Switch](https://www.switches.co.kr/tip/278)
